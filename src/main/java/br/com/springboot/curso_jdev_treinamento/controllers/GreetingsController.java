...
public class GreetingsController {
    ...
    @ResponseBody /*Descrição da resposta*/
    public ResponseEntity<List<Usuario>> buscarPorNome(@RequestParam(name = "name") String name) {/*Recebe os dados para consultar por parte do nome*/
    	
    	List<Usuario> usuario = usuarioRepository.buscarPorNome(name.trim().toUpperCase());/*toUpperCase tira a diferenciação de maiúsculo e minúsculo*/
